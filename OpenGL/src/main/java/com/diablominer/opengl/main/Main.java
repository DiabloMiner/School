...
public class Main {
    ...
    private void init() throws Exception {
        ...
        // pointLight = new PointLightSource("./src/main/resources/models/cube/cube.obj");
    ...
    private void render() {
        ...
        dirLight.setUniforms(Transforms.vectorToUnitVector(200.0f, 200.0f, -100.0f), new Vector3f(0.1f, 0.1f, 0.1f), new Vector3f(0.3f, 0.3f, 0.3f), new Vector3f(0.8f, 0.8f, 0.8f), shaderProgram);
        // pointLight.setUniforms(new Vector3f(5.0f * (float) Math.cos(GLFW.glfwGetTime()), 5.0f * (float) Math.sin(GLFW.glfwGetTime()), 5.0f * (float) Math.cos(GLFW.glfwGetTime())), new Vector3f(0.3f, 0.3f, 0.3f), new Vector3f(0.7f, 0.7f, 0.7f), new Vector3f(1.0f, 1.0f, 1.0f), 1.0f, 0.22f, 0.20f, shaderProgram);
        spotLight.setUniforms(camera.cameraPos, camera.cameraFront, new Vector3f(0.2f, 0.2f, 0.2f), new Vector3f(0.5f, 0.5f, 0.5f), new Vector3f(1.0f, 1.0f, 1.0f), 1.0f, 0.22f, 0.20f, 12.5f, 17.5f, shaderProgram);
        for (int i = 0; i < pointLights.size(); i++) {
            pointLights.get(i).setUniforms(Transforms.getProductOf2Vectors(pointLightPositions[i], new Vector3f((float)Math.cos(GLFW.glfwGetTime()), (float)Math.sin(GLFW.glfwGetTime()), (float)Math.cos(GLFW.glfwGetTime()))), new Vector3f(0.3f, 0.3f, 0.3f), new Vector3f(0.7f, 0.7f, 0.7f), new Vector3f(1.0f, 1.0f, 1.0f), 1.0f, 0.22f, 0.20f, i, shaderProgram);
        }
