...
public class MyRenderingEngine extends RenderingEngine {
    ...
    public MyRenderingEngine(LogicalEngine logicalEngine, Window window, Camera camera) throws Exception {
        ...
        Renderable reflectionCube = new Model("./src/main/resources/models/HelloWorld/cube.obj", reflectionRenderingEngineUnit, new Vector3f(-15.0f, 0.0f, 25.0f));
        Renderable refractionCube = new Model("./src/main/resources/models/HelloWorld/refractionText.obj", refractionRenderingEngineUnit, new Vector3f(-10.0f, 0.0f, 20.0f));
        ...
        GL33.glTexImage2D(GL33.GL_TEXTURE_2D, 0, GL33.GL_DEPTH24_STENCIL8, 1024, 1024, 0, GL33.GL_DEPTH_STENCIL, GL33.GL_UNSIGNED_INT_24_8, (ByteBuffer) null);
    ...
    private void updateUniformBufferBlocks(Camera cam) {
        ...
        Matrix4f lightProjection = new Matrix4f().identity().ortho(-30.0f, 30.0f, -30.0f, 30.0f, 0.1f, 120.0f);
