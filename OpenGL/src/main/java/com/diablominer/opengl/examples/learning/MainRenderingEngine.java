...
public class MainRenderingEngine extends RenderingEngine {
    ...
    public MainRenderingEngine(Window window, Camera camera) throws Exception {
        ...
        RenderingEngineUnit standardRenderingEngineUnit = new StandardRenderingEngineUnit(shaderProgram, new Renderable[] {helloWorld});
        ...
        Light.createShadowRenderers(standardRenderingEngineUnit.getRenderables().toArray(Renderable[]::new));
    }
