...
public class LightCasters {
    ...
    public static void init() throws Exception {
        ...
        window = GLFW.glfwCreateWindow(1280, 720, "Light Casters / Light Sources",0, 0);
        if (window == 0) {
            GLFW.glfwTerminate();
        ...
        int fragmentShader = createShader("LC_FS", GL33.GL_FRAGMENT_SHADER);
    ...
    public static void update() {
        ...
        GL33.glUniform3f(GL33.glGetUniformLocation(shaderProgram, "myDirLight.ambient"), 0.0f, 0.0f, 0.2f);
        GL33.glUniform3f(GL33.glGetUniformLocation(shaderProgram, "myDirLight.diffuse"), 0.0f, 0.0f, 0.8f);
        GL33.glUniform3f(GL33.glGetUniformLocation(shaderProgram, "myDirLight.specular"), 0.0f, 0.0f, 0.0f);
        GL33.glUniform3f(GL33.glGetUniformLocation(shaderProgram, "myPointLight.position"), -1.5f, 1.0f, 1.5f);
        GL33.glUniform3f(GL33.glGetUniformLocation(shaderProgram, "myPointLight.ambient"), 0.0f, 0.2f, 0.0f);
