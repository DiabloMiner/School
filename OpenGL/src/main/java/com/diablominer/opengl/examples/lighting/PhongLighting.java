...
public class PhongLighting {
    ...
    public static void init() throws Exception {
        ...
        window = GLFW.glfwCreateWindow(1280, 720, "Phong Lighting",0, 0);
        if (window == 0) {
            GLFW.glfwTerminate();
        ...
        int fragmentShader = createShader("PL_FS", GL33.GL_FRAGMENT_SHADER);
    ...
    public static void update() {
        ...
        GL33.glUniform3f(GL33.glGetUniformLocation(shaderProgram, "lightColor"), 1.0f, 1.0f, 1.0f);
        GL33.glUniform3f(GL33.glGetUniformLocation(shaderProgram, "objectColor"), 1.0f, 0.5f, 0.3f);
