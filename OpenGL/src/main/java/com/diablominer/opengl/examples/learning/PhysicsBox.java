...
public class PhysicsBox extends StandardPhysicsComponent {
     ...
     */
    public PhysicsBox(Matrix4d worldMatrix, Vector3d halfLengths, Vector3d measurements, Material material, Vector3d velocity, Vector3d angularVelocity, Collection<Force> forces, double mass) {
